...
public class GuiIngameHook extends GuiIngame{
    ...
    public void drawTabGui() {
    	...
    	if (Hitchbot.tabManager.getTabs().get(2).isExpanded()) {
        	...
        	mc.fontRendererObj.drawString("WarzAim", 85, 71, isEnabled("WarzAim") ? 0x0000ff00 : 0xffffffff);
        	...
        	mc.fontRendererObj.drawString("WarzAimNS", 85, 111, isEnabled("WarzAimNS") ? 0x0000ff00 : 0xffffffff);
    	}
    }
}
